...
public class WordCount {
  ...
  public interface WordCountOptions extends PipelineOptions {
    ...
    @Default.String("gs://dataflow-apache-quickstart_encargo3bigdata/entrada/file.txt")
    String getInputFile();
